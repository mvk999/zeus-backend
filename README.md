...
- **POST /api/usuario/esqueci-senha**: Envia um código de recuperação para o e-mail do usuário

- **POST /api/usuario/redefinir-senha**: Redefine a senha do usuário com o código de recuperação
